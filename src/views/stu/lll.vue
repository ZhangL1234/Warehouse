        ...
        <el-row type="flex" justify="space-around">
            <el-col :span="9">
                <div class="grid-content ">
                    ...
                    <div class="sec-box">
                        <div>
                            <tree-menu :label="data1[0].name" :nodes="data1[0].children" :key="data1[0].children.id"  :depth="0" class="root-tree"></tree-menu>
                        </div>
                    </div>
                            ...
                            if(res.data.children[i].children[j].children.length>0){
                                for(var z=0;z<res.data.children[i].children[j].children.length;z++){
                                    this.children[i].children[j].children.push({
                                        name:res.data.children[i].children[j].children.title,
                                        id:res.data.children[i].children[j].children.id,
                                        parentId:res.data.children[i].children[j].children.parentId,
                                        children:[],
                                    })
                                }
